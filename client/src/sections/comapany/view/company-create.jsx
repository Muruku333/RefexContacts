        ...
        <Card>
          ...
          <Box px={5} pb={5} sx={{ flexGrow: 1 }}>
            <Grid container spacing={2} columns={{ xs: 4, sm: 19, md: 19 }}>
                ...
                <>
                  ...
                  <Grid xs={4} sm={7} md={7}>
                    <TextField
                      ...
                      onChange={(event) => {
                        handleInputChangeBranch('googleMapLink', event.target.value);
                      }}
                  ...
                  <Grid
                    ...
                    alignItems="center"
                  >
                    <Button color="info" variant="contained" onClick={addBranch} aria-label="add" size="large">
                      <Iconify icon="eva:plus-outline" fontSize="inherit" />
                    </Button>
                  </Grid>
                </>
              ))}
              ...
              <Grid xs={4} sm={7} md={7}>
                <Grid container spacing={5} mt={3} columns={{ xs: 4, sm: 7, md: 7 }}>
                  <Grid xs={2} sm={3.5} md={3.5}>
